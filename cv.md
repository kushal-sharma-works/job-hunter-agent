...
Bengaluru, India · kushalsharmaworks@gmail.com · +91 8800191369 · [linkedin.com/in/kushalsharmaworks](https://linkedin.com/in/kushalsharmaworks)

---

## Summary

Backend-focused full-stack software engineer at A.P. Moller-Maersk with strong experience in Kotlin, Java, Spring Boot, and microservices. Improved API reliability by 30% while raising standards across CI/CD and testing. Experienced collaborating with engineering teams across Europe and multiple time zones. Promoted for consistently delivering high-impact features. Open to relocation across Europe.

---

## Skills

- **Backend & APIs:** Java, Kotlin, Spring Boot, REST, gRPC, GraphQL
- **Data & Persistence:** PostgreSQL, Hibernate, Liquibase, Flyway
- **Security:** OAuth2, OIDC, Spring Security, JWT
- **Architecture:** Microservices, Event-Driven (Kafka), Caching (Redis, Caffeine)
- **Frontend:** React, TypeScript, Next.js
- **Cloud & DevOps:** Azure, Docker, Kubernetes, Terraform, GitHub Actions (CI/CD)
...
### Software Engineer
**A.P. Moller-Maersk** · Bengaluru, India · *April 2025 – Present*
...
**A.P. Moller-Maersk** · Bengaluru, India · *August 2022 – March 2025*
...
**A.P. Moller-Maersk** · Bengaluru, India · *November 2021 – July 2022*
...
### Auctor Platform
[github.com/auctor-platform/auctor-platform](https://github.com/auctor-platform/auctor-platform) · *January 2026 – Present*
...
Visvesvaraya Technological University (VTU) · Bengaluru, India · 2022 · GPA: 8.24/10
...
**Interests:** MMA practitioner · Active member of a vegan community based in Amsterdam · Open source contributor · Avid traveller with an interest in cross-cultural experiences